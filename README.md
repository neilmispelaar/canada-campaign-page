...
* [Building Mockups](#building-mockups)
  ...
  * [Step 3](#step-3-review-the-different-breakpoints-on-canadaca)
...
* Global Header - Medium devices Desktops (=992px)[PSD](/templates/global-header-medium-desktop.psd) 
* Global Header - Large devices Desktops (=1200px)[PSD](/templates/global-header-large-desktop.psd) 
...
* Reduced Header - Medium devices Desktops (=992px)[PSD](/templates/reduced-header-medium-desktop.psd) 
* Reduced Header - Large devices Desktops (=1200px)[PSD](/templates/reduced-header-large-desktop.psd) 
...
![Screenshot of Canada.ca with global header in mobile](/images/global-header-mobile-1.png)


#### Reduced Widescreen Desktop Version

![Screenshot of Canada.ca with reduced header in wide screen desktop](/images/reduced-header-desktop.png)


#### Reduced Mobile Version

![Screenshot of Canada.ca with reduced header in mobile](/images/reduced-header-mobile.png)
